...
%\renewcommand{\frametitle}[1]{\centering\Huge\textbf{{#1}}\normalsize}
...
\begin{column}{0.49\paperwidth}
%\begin{figure}
%\includegraphics[width=\textwidth]{AG.gif}
%\includegraphics[width=\textwidth]{AG.png}
%\end{figure}
%\animategraphics[loop,autoplay,width=\textwidth]{10}{AG/AG-}{0}{2000}
%\begin{figure}
%\includemedia[width=\textwidth,height=\textheight,activate=pageopen,addresource=retro.mp4]{}{retro.mp4}
%\end{figure}
\begin{figure}
%\movie[autostart,loop]{\includegraphics[width=\textwidth]{AG.png}}{Images/AG.mp4}
